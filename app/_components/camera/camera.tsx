...
export default function CameraPage(): React.ReactNode {
    ...
    <div>
      <Wrapper>
        ...
        <Control>
          ...
          />
          <button id="save-photo-button" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Save Photo To Computer</button>
          <TakePhotoButton
            onClick={() => {
              if (camera.current) {
